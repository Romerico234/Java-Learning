...
public class Task3_1 {
    public static void main(String[] args) {
        ...
        UnorderedArrayList list1 = retrieveFromFile(input.next());

        System.out.print("Please input the name of the file to be opened for the second list: ");
        UnorderedArrayList list2 = retrieveFromFile(input.next());
        ...
        UnorderedArrayList merged_list = list1.merge(list2);
        merged_list.print();
    ...
    public static UnorderedArrayList retrieveFromFile(String fileName) {
        int size = 0;
        UnorderedArrayList list = null;
        try {
            ...
            if (size == 0) {
                ...
                list = new UnorderedArrayList(size);
                while (inputFile.hasNext()) {
                    if (inputFile.hasNextInt()) {
                        list.insertEnd(inputFile.nextInt());
                    } else
                        inputFile.next();
                }
            }
